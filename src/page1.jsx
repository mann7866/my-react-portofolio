...
import Navbar from "./components/pages/page1/Navbar";
            ...
            <div className="hero grid md:grid-cols-2 items-center pt-20 xl:gap-0 gap-6 grid-cols-1">
              <div className="animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <p className="text-base/loose mb-6 opacity-50">
                  ...
                  bersemangat dalam menjalankan setiap tanggung jawab, baik
                  dalam pengembangan antarmuka pengguna (frontend) maupun logika
                  sistem di sisi server (backend). Saya berkomitmen untuk
                  memberikan hasil terbaik dalam setiap proyek yang saya
                  kerjakan, serta terus belajar dan beradaptasi dengan
                  perkembangan teknologi untuk menghasilkan solusi digital yang
                  optimal.
                </p>
